...
object CellScorer extends Scorer {
  ...
  def panelScore(panel: Panel) = {
    ...
    // @formatter:off
    (
      (c >>  0 & 1) *  45 + (c >>  1 & 1) * -11 + (c >>  2 & 1) *   4 + (c >>  3 & 1) *  -1
    + (c >>  4 & 1) *  -1 + (c >>  5 & 1) *   4 + (c >>  6 & 1) * -11 + (c >>  7 & 1) *  45
    + (c >>  8 & 1) * -11 + (c >>  9 & 1) * -16 + (c >> 10 & 1) *  -1 + (c >> 11 & 1) *  -3
    + (c >> 12 & 1) *  -3 + (c >> 13 & 1) *  -1 + (c >> 14 & 1) * -16 + (c >> 15 & 1) * -11
    ...
    + (c >> 48 & 1) * -11 + (c >> 49 & 1) * -16 + (c >> 50 & 1) *  -1 + (c >> 51 & 1) *  -3
    + (c >> 52 & 1) *  -3 + (c >> 53 & 1) *  -1 + (c >> 54 & 1) * -16 + (c >> 55 & 1) * -11
    + (c >> 56 & 1) *  45 + (c >> 57 & 1) * -11 + (c >> 58 & 1) *   4 + (c >> 59 & 1) *  -1
    + (c >> 60 & 1) *  -1 + (c >> 61 & 1) *   4 + (c >> 62 & 1) * -11 + (c >> 63 & 1) *  45
    )
    // @formatter:on
  }
